...
void main (int argc, char *argv[])
{
 ...
 if (argc != 2) {
  ...
  for(i=0; i<numprocs; i++) {
    ditoa(i,id_str);
    process_create(PRODUCER_CONSUMER, h_mem_str, s_procs_completed_str_pc,id_str,lock_str,producer,s_fullslots_str,s_emptyslots_str, NULL);
  //  Printf("Producer_Consumer Process %d created\n", i);
    process_create(PRODUCER_CONSUMER, h_mem_str, s_procs_completed_str_pc,id_str,lock_str,consumer,s_fullslots_str,s_emptyslots_str, NULL);
  }

...
void main (int argc, char *argv[])
{
  ...
  mbox_t mbox_H2O;           // Handle to the mailbox
  ...
  if (mbox_send(mbox_H2O,sizeof(missile_code),(void *)&mc) == MBOX_FAIL) {
     Printf("Could not send message to mbox_H2O\n");
     Exit();
  }
  else Printf("Create 1 H2O\n");

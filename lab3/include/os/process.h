...
#define PROCESS_STATUS_YIELDING 0x20
...
typedef struct PCB {
  ...
  int           cpu_jiffies;     // Cumulative CPU jiffies
  double        estcpu;          //estimated cpu time
  int           sleep_jiffies;   // Sleep time
  int           sleep_start_jiffies; //sleeping start time
  int           switch_in_jiffies; //The time switched in
  int           switch_out_jiffies; //The time switched out
